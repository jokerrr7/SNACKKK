...
message = message..' ['..info.username..'](T.ME/UU_snak)  \n'
...
return '✤ اصدار سورس سناك*v'..version..'* \n'
end
...
local inline = {{{text="Source Channel : 𝚂𝙾𝚄𝚁𝙲𝙴 SNACK",url="T.ME/UU_snak"}}}
send_key(msg.sender_user_id_,'  [Source : 𝚂𝙾𝚄𝚁𝙲𝙴 SNACK ](T.ME/UU_snak)',nil,inline,msg.id_)
return false
end
...
if MsgText[1]== "سناك" or MsgText[1]=="سناك" then
local inline = {{{text="Source Channel : 𝚂𝙾𝚄𝚁𝙲𝙴 SNACK",url="T.ME/UU_snak"}}}
...
elseif Text== "hell" or Text== "سناك" or Text== "مطور السورس" then return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس](https://t.me/UU_snak)")
