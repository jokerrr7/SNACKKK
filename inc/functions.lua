...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(ws..":NameBot:") or "𝚂𝙾𝚄𝚁𝙲𝙴 SNACK"
...
usernn = data.username_ or "UU_snak"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "UU_snak"
end
Name = Name:gsub('[[][]]','')
...
var = 'هذا البوت' 
elseif UserID == 1765160742 or UserID == 1325450849 then 
var = 'مطور السورس'
...
message = message ..i.. '-l ['..info.username..'](t.me/UU_snak) \n'
end
...
message = message ..k.. '-l ['..info.username..'](t.me/UU_snak) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/UU_snak) l » (`' ..v.. '`) \n'
end
end
end
